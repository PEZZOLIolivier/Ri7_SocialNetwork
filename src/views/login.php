...
<head>
    ...
    <title>Ri7 Mini Réseau Social | Connexion</title>
</head>
<body class="h-screen">
    <?php  
        include('header.php'); 
    ...
    <div class="flex flex-col justify-center px-6 py-6 lg:px-8 border-solid container mx-auto my-5 rounded-xl shadow">
      ...
      <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        <form class="space-y-6" action="/login" method="POST">
          ...
          <div>
            <button value="Login" type="submit" class="flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Connexion</button>
          </div>
        </form>
    </div>
</body>
